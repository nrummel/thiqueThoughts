---
title: Bouldering Excellence - Overview
date: 2026-01-19
draft: false
---
...
Ideally, we should assess climbing from two angles. One where we can get accurate measurements. In this domain, I think we should pull out all the stops and do real statistics, not just use high school level tools. When  the reliable data is exhausted, then a more qualitative approach is necessary. This may requires us to listen to god forsaken [podcasts](https://www.youtube.com/@testpiece) or read ["Pringle paragraphs"](https://www.instagram.com/p/22V6tnnQl0/?utm_source=ig_web_copy_link&igsh=NTc4MTIwNjQ2YQ==) to better understand the complexity of the sport. 
...
It drives me crazy when climbers say things like "well, grades are so subjective, so one really **cannot say anything** meaningful" or something to that effect. Climbing is a younger sport and reliable data is less available, but in my opinion we can have a much more articulate discussion.
...
Notice, that a priori we hade to choose what goes into the data represenation of the climber $C$ and how to weigh the data with $F_\mathrm{dingus}$. Both $C$ and $F_\mathrm{dingus}$ can be as simple/complicated as they needs to be... For instance, one could consider $C$ to include:
...
The list of potential factors to consider in an assesment of a climber can continue on and on. Obviously some factors feel more important than other, and some may suggest that we should completely disregard some of the factors I listed above. 
...
## Historical Analysis with $F_\mathrm{8a.nu}$ 
Ok, I don't want to dwell on [Jens Larssen's](https://www.8a.nu/articles/user-guide-and-faq) personal weighting function long because he is just another dingus. Furthermore, his website gamifies climbing in a way that may not be very healthy or conducive to long term progression, but score is *one valid* way to compare bouldering accomplishment. My hope is by giving you a taste of what can been said with my two pronged approach will get you to come back for more as I develope better statistics and analysis than those that stem from $F_\mathrm{8a.nu}$. 
...
> 
>Current, social media is not the right solution. Professional athletes in other sports vary in how much they share about their personal lives. This is fair. It is valid to not want to vlog your entire life. This is why the current status quo is worse than 8a.nu's peak popularity. 
>
...
>[!error]  SPONSORS
> **Please require you athletes to make their ticklists publicly available.** 
> I do not care where the log their climbs, but it is a true loss to climbing spectators everywhere that we do not get to know what is happening in the sport we love.
...
![[scoreDist2019.png|center 300]]  ![[scoreDist2025.png|center 300]]
...
This is indicative of how bouldering culture has changed. Boulders are no longer optimizing to have the best 10 climbs on their *score card* according to $F_\mathrm{8a.nu}$. To this point, we see that the sample size of people logging their climbs on the website has decreased since 2022. This could be because competitors like Kaya have stolen market share (I personally doubt that). Or perhaps Mr. Raboutou's place in the zeitgeist is so dominate that all the young guns have followed suite and no longer log anywhere 😪. Both are unlikely in my opinion. Rather,  professional climbers now get more attention on the platforms of today: Instagram, YouTube, etc. At a minimum, this requires one or two big grades a year. The canonical example of this behavior is Simon Lorenzi. Like clock work, since 2021 the man has pumped out at least one send of a boulder he can say is 9A (with a hiccup of *only* sending 8C+ in 2024). Unfortunately Simon does not have a ticklist publicly available. I cannot provide as deep of an analysis as I would like, but a cursory glance of his [wiki](https://en.wikipedia.org/wiki/Simon_Lorenzi) demonstrates that his tick list depth leave much to be desired when we compare it to likes of the true 🐐s.

The  attention economy effects more than just the strategy of professional climbers, it also is effecting the grades people take for their ascents. Because "the algorithm" has learned that only 9A gets likes, comments, and shares, climbers have responded by inflating their grades. The statistics point to this. 

>[!note] Side Note: More plots
>If you want access to more plots, see the [[appendixBoulderingExcellence|appendix]].
