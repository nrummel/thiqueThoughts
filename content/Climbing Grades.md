...
Currently, most rock climbing competitions get around the difficulty of relying on grades by instead having the entire field of climbers attempt the same problems, and then evaluating performance by seeing who can complete the most climbs. There are also some nuances for partial credit and tie-breaking, see the [IFSC Rules](https://images.ifsc-climbing.org/ifsc/image/private/t_q_good/prd/y8rbz5wvclz31na8qs2s.pdf). These competitions are held on synthetic climbing walls with rock climbs made specifically for competition.  
